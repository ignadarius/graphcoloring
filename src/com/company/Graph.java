...
public class Graph {
    ...
    private Map<Integer,NodeInfo> vInfo;
    ...
    public Set<Integer> getIndependentSet(){
        ...
        l.addAll(independentSet);
        for (Integer v: l){
            Future<Boolean> f = exec.submit(()->{return checkVertext(v);});
            list.add(f);
        }
